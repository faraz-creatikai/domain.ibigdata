    ...
    return (
        <ProtectedRoute>
            ...
            />
            {
              ...
              <div className="flex justify-between items-center p-6 bg-gradient-to-r from-[var(--color-secondary-darker)] to-[var(--color-secondary)] text-white sticky top-0 z-10 backdrop-blur-md bg-opacity-95">
